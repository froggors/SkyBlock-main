...
public class ItemHandler {
    ...
    public static ItemStack frog_bow;
    ...
    public static void initBow(){
        ...
        frog_bow = createInGameBow(Material.BOW, ChatColor.GOLD + "Frog Bow", ReforgeTypes.NO_REFORGE, 1, addLore(createEmptySpace(), "&7Deals &a-100% &7damage to", "&7Frogs."), true, false, null, null, null, 0, null, "LEGENDARY BOW", 500, 360, 85, 250, 0, 0, 100, 0, true);
    }
